...
export async function GET(request: NextRequest) {
  ...
  const state = buildMetaState(membership.organization_id, 'account');
  ...
  // Account-level only. No page scopes here → Meta's consent screen won't show the
  // page chooser; the user just approves the business/BM account.
  ...
  oauthUrl.searchParams.set('scope', 'business_management,ads_read,ads_management');
