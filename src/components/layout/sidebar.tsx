...
const NAV_ITEMS_BASE = [
  ...
  { id: 'inbox', labelKey: 'inbox', href: '/inbox', icon: MessagesSquare },
      ...
      <div className="p-4 border-b border-gray-200 flex items-center justify-between min-h-[56px]">
        {collapsed ? (
          <div className="group relative flex items-center justify-center w-full h-10 rounded-lg overflow-hidden">
            ...
            >
              <img src="/dijigrow-logo.png" alt="DijiGrow" style={{ width: 36, height: 36 }} className="object-contain" />
            </Link>
            <button
          ...
          <>
            <Link href="/dashboard" className="flex-shrink-0">
              <img src="/dijigrow-logo.png" alt="DijiGrow" style={{ height: 40 }} className="object-contain cursor-pointer" />
            </Link>
            <button
              onClick={toggleCollapse}
        ...
        {dropdownOpen && (
          ...
          >
            ...
            <div className="py-1">
              ...
              <Link href="/hesabim" onClick={() => setDropdownOpen(false)}
                className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                <User className="w-4 h-4 text-gray-500" />
                <span>{tSidebar('hesabim')}</span>
              </Link>
              <Link href="/faturalarim" onClick={() => setDropdownOpen(false)}
                className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
